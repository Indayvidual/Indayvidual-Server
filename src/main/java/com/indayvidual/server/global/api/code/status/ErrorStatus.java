...
public enum ErrorStatus implements BaseErrorCode {
    ...
    MYPAGE_PASSWORD_MISMATCH(HttpStatus.UNAUTHORIZED, "MYPAGE4010", "현재 비밀번호가 일치하지 않습니다."),
    MYPAGE_PASSWORD_SAME(HttpStatus.BAD_REQUEST, "MYPAGE4001", "기존 비밀번호와 동일합니다."),
    MYPAGE_IMAGE_EMPTY(HttpStatus.BAD_REQUEST, "MYPAGE4002", "업로드할 이미지가 없습니다."),
